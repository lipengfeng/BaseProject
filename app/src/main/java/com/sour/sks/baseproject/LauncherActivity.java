...
public class LauncherActivity extends ListActivity {
	private static final String CATEGORY = "com.base.LAUNCHER";
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
//		System.out.println("HTTP_APP_VERSION : " + com.ww.util.PhoneUtils.getAppVer(this));
//		System.out.println("IMEI : " + com.ww.util.PhoneUtils.getIMEI(this));
//		System.out.println("HTTP_APP_MODEL : " + com.ww.util.PhoneUtils.getPhoneModel());
//		System.out.println("HTTP_APP_OS : " + com.ww.util.PhoneUtils.getAppOs());
