...
//        	throw new NullPointerException("You can add drawableRight attribute in XML");
        ...
        mClearDrawable.setBounds(0, 0, ScreenUtil.getScalePxValue(mClearDrawable.getIntrinsicWidth()), ScreenUtil.getScalePxValue(mClearDrawable.getIntrinsicHeight()));
        //默认设置隐藏图标
...
//    	setClearIconVisible(getText().length() > 0); 
    ...
    private OnClearFocusChangeListener onClearFocusChangeListener;

    public void setOnFocusChangeListener(OnClearFocusChangeListener focusChangeListener) {
    ...
    public interface OnClearListener {
        boolean onClear(ClearEditText v);
    }

    public interface OnTextChangeListener extends TextWatcher {
    }

    public interface OnClearFocusChangeListener extends OnFocusChangeListener {
    }
}
